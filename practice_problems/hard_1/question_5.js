...
an IP address using 4 dot-separated numbers, e.g., 10.4.5.11. He is not familiar with regular expressions.
...
console.log(isDotSeparatedIpAddress("192.168.0.1")); // true
console.log(isDotSeparatedIpAddress("192.168.0.1.5")); // false
console.log(isDotSeparatedIpAddress("192.168.1")); // false